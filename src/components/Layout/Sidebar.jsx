...
const Sidebar = ({ isMobile = false, isOpen = false, onClose }) => {
  ...
  // All menu items
  const allMenuItems = [
    { path: '/', label: 'Dashboard', icon: '📊', roles: ['admin', 'manager', 'staff'] },
    { path: '/shops', label: 'Shops', icon: '🏪', roles: ['admin', 'manager'] },
    { path: '/users', label: 'Users', icon: '👥', roles: ['admin'] }, // Admin only
    ...
    { path: '/stock-transfers', label: 'Transfers', icon: '🔄', roles: ['admin'] }, // Admin only
    ...
    { path: '/profile', label: 'Profile', icon: '👤', roles: ['admin', 'manager', 'staff'] },
  ];
